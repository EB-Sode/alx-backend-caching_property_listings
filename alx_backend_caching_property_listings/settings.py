...
# Load the renamed environment file
...
SECRET_KEY = 'django-insecure-8)37&rdxo@mj%h3gb8qx9mond=s^^yl3w^ys_!h_fop=g$lj$e'
...
# Optional: Make Django use Redis for session caching too
